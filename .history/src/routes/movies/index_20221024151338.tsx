...
const genresURL =
  "https://api.themoviedb.org/3/genre/movie/list?api_key=73e6f6e34b28a4c3be0f745176c8225b";
...
export const onGet: RequestHandler<Endpoint> = async () => {
  const rawGenres = (await (await fetch(genresURL)).json()) as any;
  console.log("get popular movies", rawGenres);
  const genres: Record<number, string> = rawGenres.reduce((acc, value) => {
