...
export default component$(() => {
  ...
  useMyEffect$(() => console.log("It WORKED"));
  useMyEffectQrl($(() => console.log("It also WORKED")));
  document.addEventListener("foo", () => console.log("abc"));
  useOn(
    "mousemove",
    $(() => console.log("abc"))
  );
  if (state.count > 100) {
    addLazy(1, 2).then((v) => console.log(v));
    $(() => 1 + 2).then((v) => console.log(v));
  }
  return (
    <div>
