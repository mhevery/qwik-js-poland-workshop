import { component$, useClientEffect$, useStore, QRL, useClientEffectQrl, implicit$FirstArg } from "@builder.io/qwik";
...
export useMyEffect$ = implicit$FirstArg(useMyEffectQrl);
export function useMyEffectQrl(callback: QRL<() => void>) {
  useClientEffectQrl(callback);
}
